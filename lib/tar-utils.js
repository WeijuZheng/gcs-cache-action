...
exports.extractTar = exports.createTar = exports.getTarCompressionMethod = exports.CompressionMethod = void 0;
...
function getTarCompressionMethod() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const [zstdOutput, zstdVersion] = yield exec
            ...
            .catch(() => ['', null]);
        console.log(zstdOutput, zstdVersion);
...
exports.getTarCompressionMethod = getTarCompressionMethod;
